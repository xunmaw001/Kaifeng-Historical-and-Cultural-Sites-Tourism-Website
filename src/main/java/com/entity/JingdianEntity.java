...
public class JingdianEntity<T> implements Serializable {
     ...
     * 景点游玩项目
     */
    @ColumnInfo(comment="景点游玩项目",type="varchar(200)")
    @TableField(value = "jingdian_xiangmu")

    private String jingdianXiangmu;
	 ...
	 * 获取：景点游玩项目
	 */
    public String getJingdianXiangmu() {
        return jingdianXiangmu;
    }
    /**
	 * 设置：景点游玩项目
	 */

    public void setJingdianXiangmu(String jingdianXiangmu) {
        this.jingdianXiangmu = jingdianXiangmu;
    }
    /**
	 * 获取：现价/积分
	 */
    ...
    public String toString() {
        return "Jingdian{" +
            ...
            ", jingdianXiangmu=" + jingdianXiangmu +
