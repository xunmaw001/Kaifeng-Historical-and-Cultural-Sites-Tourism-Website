...
var centerMenu = [
    ...
    ,{
        name: '旅游攻略收藏',
        url: '../gonglueCollection/list.html'
    }
    ,{
        name: '景点收藏',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/kaifengmingshenggujilvyou/admin/dist/index.html#/login";
